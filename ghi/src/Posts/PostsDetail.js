      ...
      <Card className="w-full max-w-[26rem] shadow-lg">
        ...
        <CardBody>
          ...
          <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
            ...
            >
              ...
              />
              <span>
                From User: {singlePost.user ? singlePost.user.username : ""}
              </span>
            </Typography>
            <Typography
              color="blue-gray"
            ...
            >
              ...
              <span>
                Expiration Date: {singlePost ? singlePost.produce.exp_date : ""}
              </span>
            </Typography>
            <Typography
              color="blue-gray"
            ...
            >
              ...
              <span>
                Decorative: {singlePost ? singlePost.produce.is_decorative : ""}
              </span>
            </Typography>
            <Typography
              color="blue-gray"
            ...
            >
              ...
              <span>
                Quantity: {singlePost ? singlePost.produce.quantity : ""}
              </span>
            </Typography>
            <Typography
              color="blue-gray"
            ...
            >
              <CalendarDaysIcon className="-mt-0.5 h-5 w-5 text-yellow-700" />
              <span>
                Post created on: {singlePost ? singlePost.post_created : ""}
              </span>
            </Typography>
          </div>
        </CardBody>
        <CardFooter className="pt-3">
          <Button size="lg" fullWidth={true}>
            <Link to="/deliveries">Make a delivery request!</Link>
          </Button>
          <Button size="lg" fullWidth={true}>
            <Link to={`/posts/${singlePost.posts_id}/update`}>Update Post</Link>
          </Button>
        </CardFooter>
      </Card>
    );
